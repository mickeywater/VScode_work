...
- 设计一个主要的大卡片展示**子主题名称**(占据约20%的视觉区域)
- 设计一个主要的大卡片展示**图表（可选）**(占据约33%的视觉区域)
- 其余的卡片应包含**主要要点内容（必选）**和**图片（可选）**，每个卡片有独特的标题和简短描述，标题简短，避免换行。
...
## 内容分布建议
- 主卡片：核心概念介绍**子主题名称**（20%区域）
- 4-6个中型卡片：重要**主要要点内容（必选）**和**图片（可选）**
- 1个大型卡片：展示**图表（可选）**
